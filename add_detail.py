...
class add_detail(Toplevel):
    ...
    def setup_UI(self):
        # 设置style
        self.Style01 = Style()
        self.Style01.configure("title.TLabel",font=("华文黑体",20,"bold"),foreground = "black")
        self.Style01.configure("detail.TLabel", font=("华文黑体", 12, "bold"), foreground="black")
        self.Style01.configure("TButton",font=("华文黑体",12,"bold"),foreground = "black")
        self.Style01.configure("TEntry", font=("华文黑体", 12, "bold"),width = 10)
        self.Style01.configure("TRadiobutton",font=("华文黑体",12,"bold"),foreground = "black")
