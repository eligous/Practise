...
class editpassword(Toplevel):
    def __init__(self,current_login_list):
        ...
        self.file_path = "."+os.sep+"student_mess"+os.sep+"User.txt"
    ...
    def setup_UI(self):
        ...
        self.Style01.configure("pass.TLabel", font=("华文黑体", 15, "bold"), foreground="navy")
        self.Style01.configure("TButton", font=("华文黑体", 15, "bold"), foreground="navy")
        ...
        # 账号
        self.Label_login = Label(self.Pane_detail,text = "当前用户名:",style = "pass.TLabel")
        self.Label_login.place(x=160,y=70)
        self.var_login = StringVar()
        self.Entry_login = Entry(self.Pane_detail,state=DISABLED,textvariable = self.var_login, font=("华文黑体", 15, "bold"),width = 12)
        self.Entry_login.place(x=280,y=68)

        # 旧密码
        self.Label_old_password = Label(self.Pane_detail, text="验证旧密码:",style = "pass.TLabel")
        self.Label_old_password.place(x=160, y=120)
        self.var_old = StringVar()
        self.Entry_old_password = Entry(self.Pane_detail, show="*",textvariable=self.var_old, font=("华文黑体", 15, "bold"), width=12)
        self.Entry_old_password.place(x=280, y=118)

        # 新密码
        self.Label_new_password = Label(self.Pane_detail, text="设置新密码:",style = "pass.TLabel")
        self.Label_new_password.place(x=160, y=170)
        self.var_new = StringVar()
        self.Entry_new_password = Entry(self.Pane_detail,  show="*",textvariable=self.var_new, font=("华文黑体", 15, "bold"), width=12)
        self.Entry_new_password.place(x=280, y=168)

        # 确认新密码
        self.Label_two_new_password = Label(self.Pane_detail, text="确认新密码:",style = "pass.TLabel")
        self.Label_two_new_password.place(x=160, y=220)
        self.var_two_new = StringVar()
        self.Entry_two_new_password = Entry(self.Pane_detail,  show="*",textvariable=self.var_two_new, font=("华文黑体", 15, "bold"), width=12)
